    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-white shadow-md">
        <div className="max-w-7xl mx-auto px-4 py-4 flex justify-between items-center">
          <h1 className="text-2xl font-bold text-talenthub-blue">TalentHub México</h1>
      ...
      <div className="bg-gradient-to-r from-talenthub-blue to-blue-800 text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="space-x-4">
            <Link to="/vacantes" className="bg-white text-talenthub-blue px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition inline-block">
              Ver Vacantes
            </Link>
            <Link to="/register?tipo=empresa" className="bg-orange-500 text-white px-8 py-3 rounded-lg font-bold hover:bg-orange-600 transition inline-block">
              Publicar Vacante
            </Link>
          </div>
        </div>
